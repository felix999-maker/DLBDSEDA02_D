...
reviews = positive_reviews["cleaned_reviews"]
...
bow_matrix = bow_vectorizer.fit_transform(positive_reviews["cleaned_reviews"])

#-----------------------------------------------------
# TF-IDF erstellen
#-----------------------------------------------------
tfidf_vectorizer = TfidfVectorizer()
tfidf_matrix = tfidf_vectorizer.fit_transform(positive_reviews["cleaned_reviews"])
